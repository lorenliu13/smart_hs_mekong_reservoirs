...
SAVE_DIR = Path(
    ...
    f"/mekong_lakes_swotpld_era5_ifshres10d_gritv06_202312_202602_qc_area{AREA_THRESHOLD_SQKM}_obs{OBS_COUNT_THRESHOLD}"
)
...
# ── ERA5-Land ─────────────────────────────────────────────────────────────────
ERA5_BASE_DIR = Path(
    f"/data/ouce-grit/cenv1160/smart_hs/processed_data/mekong_river_basin_reservoirs/era5_land_daily_catchment_level/daily_per_lake_area_{AREA_THRESHOLD_SQKM}_sample_{OBS_COUNT_THRESHOLD}"
)

# ── ECMWF IFS ────────────────────────────────────────────────────────────────
ECMWF_BASE_DIR = Path(
    f"/data/ouce-grit/cenv1160/smart_hs/processed_data/mekong_river_basin_reservoirs/ecmwf_ifs_daily_catchment_level/hres/daily_per_lake_area_{AREA_THRESHOLD_SQKM}_sample_{OBS_COUNT_THRESHOLD}"
)
FORECAST_HORIZON = 10
