#!/bin/bash
#SBATCH --job-name=full_inference_lstm_wsend
#SBATCH --output=full_inference_lstm_wsend.out
#SBATCH --error=full_inference_lstm_wsend.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python wsend_lstm_training/run_full_inference_lstm_wsend_temporal_cv.py \
    --config          "$CONFIG" \
