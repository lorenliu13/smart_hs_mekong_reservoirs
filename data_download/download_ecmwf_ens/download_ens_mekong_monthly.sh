...
#SBATCH --output=ens_download_monthly.out        # Standard output file
#SBATCH --error=ens_download_monthly.err         # Standard error file
...
#SBATCH --time=336:00:00                   # Job run time (72 hours)
...
python -u download_ens_mekong_monthly.py