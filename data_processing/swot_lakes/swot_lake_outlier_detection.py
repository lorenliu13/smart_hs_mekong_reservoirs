...
) / f"full_swot_lake_df_{TIME_RANGE}.csv"
...
OUTPUT_CSV         = OUTPUT_DIR / f"swot_lake_{TIME_RANGE}_outlier_flag.csv"
OUTPUT_SUMMARY_CSV = OUTPUT_DIR / f"swot_lake_{TIME_RANGE}_outlier_flag_summary.csv"
